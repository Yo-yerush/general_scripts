...
dir.create("/home/yoyerush/yo/genePlot_101124", showWarnings = FALSE)

svg(paste0("/home/yoyerush/yo/genePlot_101124/genePlot_", main_title, ".svg"), width = 4.75, height = 2.75, family = "serif")
...
cor_tairs = read.table("/home/yoyerush/yo/genePlot_101124/corr_gene_list.txt", header = TRUE)[,1]
i.L = length(cor_tairs)/10
i.I = 1

mclapply(cor_tairs, function(i.tair) {
  genePlot_fun(tair_id = i.tair)
  #cat("> ", i.tair, " ",i.I " ot of ", i.L, " loops\n")
  #i.I <<- i.I + 1
}, mc.cores = 10)
...
genePlot_fun(tair_id = "AT1G69380")
genePlot_fun(tair_id = "AT1G38131")
genePlot_fun(tair_id = "AT3G17390")
genePlot_fun(tair_id = "AT1G35350")
