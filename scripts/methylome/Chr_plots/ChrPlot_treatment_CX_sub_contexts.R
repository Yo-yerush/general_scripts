...
for (treatment in c("wt", "mto1", "mto3", "EV_dCGS", "dCGS", "sseHigh", "sseLow", "EV_SSE")) {
  ...
  for (context_name in names(context_list)) {
    ...
    dir.create(paste0("/home/yoyerush/yo/methylome_pipeline/Chr_plots/all_treatments_sub_contexts"), showWarnings = F)

    svg(paste0("/home/yoyerush/yo/methylome_pipeline/Chr_plots/all_treatments_sub_contexts/", treatment, "_sub.", context_name, "_ChrPlot.svg"),
