...
for (treatment in c("mto1","mto3")) {
  ...
  for (context in c("CG","CHG","CHH")) {
      ...
      dir.create("C:/Users/yonye/Migal/Rachel Amir Team - General/yonatan/methionine/NGS_merged_results/circular_plot_res/DMRs_TEs/", showWarnings = F)
      dir.create(paste0("C:/Users/yonye/Migal/Rachel Amir Team - General/yonatan/methionine/NGS_merged_results/circular_plot_res/DMRs_TEs/",treatment), showWarnings = F)
      #####################################
      ############# the plot #############
      svg(paste0("C:/Users/yonye/Migal/Rachel Amir Team - General/yonatan/methionine/NGS_merged_results/circular_plot_res/DMRs_TEs/",treatment,"/",treatment,"_DMRs_TEs_",context,"_circular_plots.svg"), width = 3.25, height = 3.25, family = "serif")
      ...
      circos.genomicDensity(list(dmrs_file[dmrs_file$meth_log2FC > 0, 1:3],
                            ...
                            col = c("#FF000080","#304ed180"), border = T, track.height = 0.35)

      circos.genomicDensity(#list(RNA_transcriptsLoc[2:4],
                                 TE_4_dens[1:3],#),
                            bg.col = "#fafcff", bg.border = NA, count_by = "number",
                            col = #c("gray",
                                    "#fcba0320", border = T, track.height = 0.25)
...
# legends
{
  ...
  svg(paste0("C:/Users/yonye/Migal/Rachel Amir Team - General/yonatan/methionine/NGS_merged_results/circular_plot_res/DMRs_TEs/legends.svg"), width = 6, height = 5.75, family = "serif")
  #par(mfrow=c(3,1))
