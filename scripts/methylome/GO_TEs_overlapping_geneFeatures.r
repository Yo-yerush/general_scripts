...
for (GO_type_loop in c("BP", "MF", "CC")) {
    ...
    bubble_plot = res_bind %>%
        ...
        scale_color_gradient("p.value", low = "#cf534c", high = "black") + # theme_classic() +
...
svg("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_DEGs_overlap_with_TEs.svg", width = 5, height = 6, family = "serif")
print(bubble_plot)
dev.off()
