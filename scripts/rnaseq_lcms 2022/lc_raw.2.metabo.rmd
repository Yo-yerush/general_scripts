...
# list of unique compounds and there pathways
csv_1 = "P:/yonatan/RNAseq_yonatan_2021/lcms/lcms_results_060722/cor.map/cor.map.2nd/comp.list.for.cor.map.updated.csv"

# samples in order of lcms running
csv_2 = "P:/yonatan/RNAseq_yonatan_2021/lcms/data.from.lcms/LCMS_rnaseq_samples/LCMS_rnaseq.samples_190122.csv"

# row data from lcms (excel file from lcms in Tel-Hai)
csv_3 = "P:/yonatan/RNAseq_yonatan_2021/lcms/data.from.lcms/All_Compounds_pom_P_060722.csv"

#####################################


# path for the saved files directory
# dont forget "/"  in the end of that row
path.for.saving.files = "P:/yonatan/RNAseq_yonatan_2021/lcms/csv_files_for_metabo/comp.with.pathway.P/" 
date = "100722"

# column number for "Name" and "Norm..Area..XXX.raw..F4" (XXX is a sample number) of you samples, without BLK and QC.
# to get numbers easily, run script and than run the function: names(lc.mzcl)
column_number = c(3,22:51) 

# fenotype description for metaboanalyst analysis
