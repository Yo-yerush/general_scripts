bhlh_compounds_plot_save = function(comp.name,
                               file_for_metabo = "P:/yonatan/RNAseq_yonatan_2021/lcms/lcms_results_060722/transgenic/transgenic_files/files_for_metaboanalyst_18072022/comp.name.for.metabo.18072022.csv",
...
comp.plot = data %>%
  ...
  geom_boxplot(fill=c("#5c3e27","grey70"), ) + 
...
#  stat_summary(fun.y=mean, geom="point", shape=23, size=4)  
  ...
  annotate("text", x = 1.5, y = max(data[,2])*1, label= p_value_lable, size = 8)
