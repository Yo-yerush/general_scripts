...
path = "P:/yonatan/RNAseq_yonatan_2021/SDH_variants_RNAseq_yonatan/"
setwd(path)
...
dir.create(paste("P:/yonatan/RNAseq_yonatan_2021/lcms/PatternHunter/PatternHunter.files/results/", feature.name, sep = ""))
path.to.save.files = paste("P:/yonatan/RNAseq_yonatan_2021/lcms/PatternHunter/PatternHunter.files/results/", feature.name, sep = "")
