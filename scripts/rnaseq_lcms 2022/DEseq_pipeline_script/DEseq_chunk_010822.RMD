...
source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
...
source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
deseq_fc("PGG_high_VS_low", "peel", c(1:9,13:30), group.A = c(4:9,19:21,25:30)) # PGG high_VS_low
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
deseq_fc("GAX4_high_VS_low", "peel", c(1:3,7:9,13:18,22:30), group.A = 25:30) # Gallic Acid X4 high_VS_low
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
deseq_fc("GAX7_high_VS_low", "peel", c(1:24,28:30), group.A = c(4:6,16:18,28:30)) # Gallic Acid X7 high_VS_low
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
deseq_fc("digalloylglucose_high_VS_low", "peel", c(1:15,22:24,28:30), group.A = 4:12) # diGalloylGlucose (HTs X3) high_VS_low
rm(deseq_fc)
...
source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
 deseq_fc("all_high_VS_low", "clone", c(1:20), "high", "low")
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
 deseq_fc("all_BanG.101_VS_danA_116", "clone", c(4:9,13:20), "high", "low")
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
 deseq_fc("all_high_VS_low_no.C1.C16", "clone", c(2:15,17:20), "high", "low")
rm(deseq_fc)

source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/DEseq_fun_yo.R")
 deseq_fc("all_high_VS_low_no.C1.C5.C16", "clone", c(2:4,6:15,17:20), "high", "low")
rm(deseq_fc)
...
source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/merge.file_venn.diagramm.R")
...
source("P:/yonatan/scripts/rnaseq_lcms 2022/DEseq_pipeline_script/merge.file_venn.diagramm.R")
venn.di("peel","up","no_parents_high_VS_low","BanG.101_VS_DanA.116",merge.file.number = "10", experiment.2 = "clone", up.down.2 = "up")
rm(venn.di)
