...
MYB6 = c("MYB6 2.1","MYB6 2.2","MYB6 3.1","MYB6 3.2","MYB6 4")
MYB8b = c("MYB8b 1.1","MYB8b 2.1","MYB8b 2.2","MYB8b 3.1","MYB8b 3.2")
bHLH94 = c("bHLH94 1.1","bHLH94 1.2","bHLH94 2","bHLH94 4")




#path = setwd("C:/Users/yonye/OneDrive/שולחן העבודה/מעבדה/RNAseq_yonatan_2021/DESeq2/transgenic/statistics/")

table = read.csv("norm.bHLH94-like_VS_EV.DE.csv")

gene.name = "XM_031522095.1"

title_main = "bHLH94-like"
...
data %>%
  ...
  scale_y_continuous(expand = c(0,0), limits = c(0,max(data[2])))
