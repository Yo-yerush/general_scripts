sdh_comp_cor = function(feature.name) {

ori_path = getwd()

path = "P:/yonatan/RNAseq_yonatan_2021/SDH_variants_RNAseq_yonatan/clone.corr/comp_name/all_high_VS_low/" # path for output files
setwd(path)

file.name = "SDH_comp_petternHunter_clone_all.csv" # locate "../" before path for output files
...
write.csv(corr.file, paste(feature.name,"_correlation_description_table.csv", sep = ""), row.names = F)
