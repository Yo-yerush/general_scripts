...
svg("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_nonCG_promoters_DEGs_overlap.svg", width = 4.25, height = 3, family = "serif")
print(bubble_plot)
dev.off()

svg(paste0("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_nonCG_promoters_DEGs_overlap_Annotated_legend.svg"), width = 1, height = 1.5, family = "serif")
