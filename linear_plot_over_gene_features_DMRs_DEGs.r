linear_plot_meth_rna <- function(
    var1_name,
    var2_name,
    var1_rnaseq_names,
    var2_rnaseq_names,
    average_meth_results_directory,
            ...
            tryCatch(
                {
                    ...
                    genotype_row <- grep("genotype", rownames(lm_model$coefficients))
    ...
    png(paste0(path_2_save.2, "lm.stats.plot.", var2_name, ".png"), width = 18, height = 7.5, units = "in", res = 300, family = "serif")
    do.call(multiplot, c(
    ...
    if (additional_plots) {
        ...
        svg(paste0(path_2_save.2, "theta_values_", var2_name, ".svg"), width = 5, height = 3, family = "serif")
        ...
        svg(paste0(path_2_save.2, "Rsqr_values_", var2_name, ".svg"), width = 5, height = 3, family = "serif")
        print(Rsqr_bar_plot)
        dev.off()
        ...
        svg(paste0(path_2_save.2, "Pseudo_Rsqr_values_", var2_name, ".svg"), width = 5, height = 3, family = "serif")
