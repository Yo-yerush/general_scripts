...
for (direction_i in c("upregulated", "downregulated")) {
    ...
    for (GO_type_loop in c("BP")) { # , "MF", "CC")) {
        ...
        res_list[[GO_type_loop]] <- allRes[allRes$Fisher <= 0.05, ]
    }
    ...
    write.csv(res_bind, paste0("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_overlap/nonCG_genes_promoters/GO_nonCG_genes_promoters_", direction_i, "_DEGs_overlap.csv"), row.names = F)
}
...
if(F) {
    ...
    svg(paste0("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_overlap/nonCG_genes_promoters/GO_nonCG_genes_promoters_", direction_i, "_DEGs_overlap.svg"), width = 4.25, height = 3, family = "serif")
    print(bubble_plot)
    dev.off()

    svg(paste0("C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/GO_overlap/nonCG_genes_promoters/GO_nonCG_genes_promoters_", direction_i, "_DEGs_overlap_Annotated_legend.svg"), width = 1, height = 1.5, family = "serif")
